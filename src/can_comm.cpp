...
{                  
    ...
    while ( Can1.read(inMsg)!=0 ) {
        ...
        case 0x200:
        {
            Serial.println("Received the EKF message msg200");
            break;
        }
        case 0x201:
        {
            Serial.println("Received the EKF message msg201");
            break;
        }
        case 0x202:
        {
            Serial.println("Received the EKF message msg202");
            break;
        }
        case 0x203:
        {
            Serial.println("Received the EKF message msg203");
            break;
        }
        case 0x204:
        {
            Serial.println("Received the EKF message msg204");
            break;
        }
        case 0x205:
        {
            Serial.println("Received the EKF message msg205");
            break;
        }
        default:
        {
